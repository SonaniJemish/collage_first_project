...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $query = "INSERT INTO details (`Name`,`Email`,`Contact`,`Password`) VALUES ('$username','$mail', '$number', '$password')";
...
<body>
  ...
  <body class="sub_page">
    ...
    <div class="container">
      <div class="contant">
        <form action="register.php" method="post" target="login.php">
          <table id="outtable" cellspacing="5px">
            ...
            <tr>
              <td><input type="submit" class="button" value="Register" style="margin: 20px;" ></td>
              <td><a href="forgot.php">Forgot Password</a></td>
            </tr>
            <tr>
              <td>Already have a account   <a href="login.php">Sign in</a></td>
            </tr>
          </table>
        </form>
      </div>
