<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $query = "Select Contact from details where name = '$username' AND password = '$password'";
    ...
    <div class="contant">
        <form action="login.php" method="post"> 
            <table id="outtable" cellspacing="5px">
                ...
                <tr>
                    <td><input type="submit" class="button" value="Sign in" style="margin: 20px;" ></td>
                    <td><a href="forgot.php">Forgot Password</a></td>
                </tr>
                <tr>
                    <td>If Don't have account   <a href="register.php">Sign Up</a></td>
                </tr>
            </table>
        </form>
    </div>
